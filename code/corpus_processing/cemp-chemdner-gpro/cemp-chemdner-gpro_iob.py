# -*- coding: utf-8 -*-
"""
Created on Mon Apr 15 02:02:32 2019

@author: Αλέξανδρος
"""
#for cemp the entity types need to be Chemicals
#for chemdner the entity types need to be Chemicals
#for gpro the entity types need to be GENE/PROTEIN

import os
from nltk.tokenize import word_tokenize

if os.path.exists("1. iob\\chemdner.iob2"):
    os.remove("1. iob\\chemdner.iob2")

output = open("1. iob\\chemdner.iob2", "a", encoding="utf8")
...
with open("chemdner_text.txt", encoding="utf8") as fi:  
    ...
    while line:
        ...
        for i in indices:#get the entities
            ...
            entities.append([int(annotations[i][1]), int(annotations[i][2]), annotations[i][3]])
